...
/*   Updated: 2023/11/23 19:09:26 by akeryan          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
//static void	plot_line_low(t_pnt3d *a, t_pnt3d *b, t_data *d)
//{
	//t_plot_vars	q;
	//t_pnt2d		*a;	
...
//static void	loop_low(t_pnt3d *a, t_pnt3d *b, t_plot_vars *q, t_data *d)
//{
	//while (a->x <= p->x1)
	//{
		//plot(a->x, a->y, d);
